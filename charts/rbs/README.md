...
| vault.janitorPubSubConfigPath | string | `nil` | Janitor related configs in Vault path prefix. Required if vault.enabled. Now those Janitor configs are generated by Terraform and output to Vault. |
